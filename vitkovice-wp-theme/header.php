...
<body>
  ...
  <nav class="navbar navbar-expand-xl navbar-dark fixed-top bg-primary" id="navbarMain">
    <div class="container">
      <a class="navbar-brand" href="<?php echo get_home_url(); ?>">
        <img src="<?php echo get_theme_root_uri()._ROOT_DIR; ?>/img/brand_dark_sm.png" alt="Aldrov logo" height="50">
      </a>
      ...
      <div class="collapse navbar-collapse d-xl-flex justify-content-between" id="navbarLinks">
        <ul class="navbar-nav overflow-hidden text-nowrap <?php if (is_home()) echo "navbar-nav-scroll"; ?>">
<?php
  if (is_home()) {
?>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#sectionKidsPark"><?php _e("Kids park", "vitkovice-wp-theme"); ?></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#sectionPricing"><?php _e("Price list", "vitkovice-wp-theme"); ?></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#sectionRental"><?php _e("Rental", "vitkovice-wp-theme"); ?></a>
          </li>
          <li class="nav-item">
